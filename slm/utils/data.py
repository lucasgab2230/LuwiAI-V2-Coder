...
def save_text_dataset(
    texts: List[str], output_dir: str, filename: str = "dataset.txt"
) -> None:
    """
...
def load_text_dataset(input_path: str, clean: bool = True) -> List[str]:
    """
...
def split_dataset(
    texts: List[str], train_ratio: float = 0.8, val_ratio: float = 0.1
) -> Dict[str, List[str]]:
    """
